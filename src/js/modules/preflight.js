export class Preflight {
    ...
    async process() {
        ...
        await this.googledoc.forEach( (value) => {
            ...
            value["votes"] = (Number.isInteger(value.votes)) ? +value["votes"] : value["votes"] ;

        });

        if (self.settings.expandible) {

            this.googledoc.splice(self.googledoc.findIndex( (i) => {

                return i.id === self.settings.optionID;
        ...
        return { database : self.googledoc, settings : self.settings }
